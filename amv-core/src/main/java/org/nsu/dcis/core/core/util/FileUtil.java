package org.nsu.dcis.core.core.util;

import org.nsu.dcis.core.core.exception.AmvFileException;
...
public class FileUtil {
    ...
    public List<FileLine> getFileLines(String fullFileName) {
        ...
        try {
            ...
            throw new AmvFileException("Unable to read lines from '" + fullFileName + "'", e);
        }
        return fileLines;
    }
}
