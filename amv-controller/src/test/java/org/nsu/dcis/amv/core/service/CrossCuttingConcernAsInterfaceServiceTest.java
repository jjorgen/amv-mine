...
public class CrossCuttingConcernAsInterfaceServiceTest {
    ...
    @Test
    public void getBeforeAdviceDetailResults() throws Exception {
        AspectMiningDetailResult aroundAdviceDetailResults = crossCuttingConcernAsInterfaceService.getBeforeAdviceDetailResults();
        assertNotNull(aroundAdviceDetailResults);
    }

    @Test
    public void getAfterAdviceDetailResults() throws Exception {
        AspectMiningDetailResult aroundAdviceDetailResults = crossCuttingConcernAsInterfaceService.getAfterAdviceDetailResults();
        assertNotNull(aroundAdviceDetailResults);
    }
